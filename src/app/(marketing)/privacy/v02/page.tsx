...
export default function PrivacyV02Page() {
  return (
    <section className="px-4 py-16">
      <article className="mx-auto max-w-3xl">
        ...
        <p className="text-muted-foreground mt-2 text-sm">
          Versione: v02 — Ultimo aggiornamento: marzo 2026
        </p>
        <p className="text-muted-foreground mt-1 text-sm">
          URL permanente:{" "}
          <Link href="/privacy/v02" className="text-primary underline">
            scontrinozero.it/privacy/v02
          </Link>
        </p>
        ...
        <div className="mt-10 space-y-8 text-sm leading-relaxed">
          ...
          <section>
            ...
            <p className="text-muted-foreground mt-2">
              Il testo della presente versione (v02) è conservato
              permanentemente all&apos;URL{" "}
              <Link href="/privacy/v02" className="text-primary underline">
                /privacy/v02
              </Link>
              {". "}La versione precedente (v01) resta accessibile all&apos;URL
              permanente{" "}
            ...
            <p className="text-muted-foreground mt-2">
              ...
              <code className="bg-muted rounded px-1">/privacy/v03</code>
