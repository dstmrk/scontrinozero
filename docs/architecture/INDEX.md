...
| Viewport / safe-area / edge-to-edge PWA           | `src/lib/pwa/viewport.ts` (`viewportFit: "cover"`, esportato dal solo `src/app/dashboard/layout.tsx`: senza quell'export ogni `env(safe-area-inset-*)` vale `0px`)                                                                                                                                     |
